  ...
  return (
    <section>
      <ProfileHeader
        ...
        imgUrl={communityDetails.image ?? "/assets/profile.svg"}
          ...
          <TabsList className="flex min-h-[50px] flex-1 items-center gap-3 bg-[#121417] text-[#EFEFEF] data-[state=active]:bg-[#0e0e12] data-[state=active]:text-[#EFEFEF]">
            {communityTabs.map((tab) => (
              <TabsTrigger
                key={tab.label}
                value={tab.value}
                className="flex min-h-[50px] flex-1 items-center gap-3 bg-[#121417] text-[#EFEFEF] data-[state=active]:bg-[#0e0e12] data-[state=active]:text-[#EFEFEF]"
              >
                <Image
                  src={tab.icon}
                  alt={tab.label}
                ...
                {tab.label === "Threads" && (
                  <p className="ml-1 rounded-sm bg-light-4 px-2 py-1 text-[#efefef]">
